...
@Database(entities = [QueuedLocation::class, SessionEvent::class, Setting::class, BluetoothDevice::class, QueuedBluetoothDevice::class], version = 9, exportSchema = false)
